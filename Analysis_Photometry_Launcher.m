...
LauncherParam.SpikesAnalysis=1;
LauncherParam.SpikesFigure=1;
% Figures - Can be changed upon loading
LauncherParam.PhotoChNames={'470-BLA' 'none' '470-VS'};
...
LauncherParam.PupilState='Outcome'; %'NormBaseline','Cue','Outcome'
% Filters
