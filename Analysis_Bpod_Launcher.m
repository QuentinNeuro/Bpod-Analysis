...
LP.P.Timing.ForceEpochTimeReset=[];     % [0 0 ; 0 2 ; 0 -0.5]; 0 0;NaN NaN;0 -0.5
%% Analysis Parameters
LP.P.Filters.Sort=1;
...
LP.P.Filters.WheelState='BaselineAVG';          % Optionss : 'BaselineAVG','CueAVG','OutcomeAVG'
...
switch LP.Analysis_type
    ...
    case 'Online'
        AB_FileOnline(LP);
    case {'Single', 'Group'}
        [Analysis,DB_Stat]=AB_FileManual(LP,DB,DB_Stat);
end