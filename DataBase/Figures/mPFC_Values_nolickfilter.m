...
plot(DB_CuedOutcome.mPFC_Values.Cue_A.Photo.Time',...
     DB_CuedOutcome.mPFC_Values.Cue_A.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values.Cue_A.Photo.DFF0Cue,'-k');
xlim([-4 4]); ylim(limy1);
title('CueA - High Value')

subplot(3,7,[5 6]) % Low Value
plot(DB_CuedOutcome.mPFC_Values.Cue_B.Photo.Time',...
     DB_CuedOutcome.mPFC_Values.Cue_B.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values.Cue_B.Photo.DFF0Cue,'-b');
xlim([-4 4]); ylim(limy1);
...
Cue(2,:)=DB_CuedOutcome.mPFC_Values.Cue_A.Photo.DFFCue-...
            DB_CuedOutcome.mPFC_Values.Cue_A.Photo.DFF0Cue;
Cue(3,:)=DB_CuedOutcome.mPFC_Values.Cue_B.Photo.DFFCue-...
            DB_CuedOutcome.mPFC_Values.Cue_B.Photo.DFF0Cue;
subplot(3,7,7)
plot(Cue,'-o')
xlim([0 4])
ylim([-2 15])
...
plot(DB_CuedOutcome.mPFC_Values.CueA_Reward.Photo.Time',...
     DB_CuedOutcome.mPFC_Values.CueA_Reward.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values.CueA_Reward.Photo.DFF0Outcome,'-k');
xlim([-0.1 2]); ylim([-5 10])

subplot(3,7,[12 13]) % Low Value
plot(DB_CuedOutcome.mPFC_Values.CueB_Reward.Photo.Time',...
     DB_CuedOutcome.mPFC_Values.CueB_Reward.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values.CueB_Reward.Photo.DFF0Outcome,'b');
xlim([-0.1 2]); ylim([-5 10]);
% Reward
...
Rew(2,:)=DB_CuedOutcome.mPFC_Values.CueA_Reward.Photo.DFFOutcome-...
            DB_CuedOutcome.mPFC_Values.CueA_Reward.Photo.DFF0Outcome;
Rew(3,:)=DB_CuedOutcome.mPFC_Values.CueB_Reward.Photo.DFFOutcome-...
            DB_CuedOutcome.mPFC_Values.CueB_Reward.Photo.DFF0Outcome;
subplot(3,7,14)
plot(Rew,'-o')
xlim([0 4])
ylim([-2 10])
