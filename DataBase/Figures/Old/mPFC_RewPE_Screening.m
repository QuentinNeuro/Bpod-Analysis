...
subplot(1,2,1)
hold on
plot(DB_CuedOutcome.mPFC_RewPE.AnticipLick_CueA_Rew.Photo.Time(i(1),:)',...
     DB_CuedOutcome.mPFC_RewPE.NoAnticipLick_CueB_Punish.Photo.DFFAVG(i(1),:)';
plot(DB_CuedOutcome.mPFC_RewPE.Uncued_Punish.Photo.Time(i(1),:)',...
     DB_CuedOutcome.mPFC_RewPE.Uncued_Punish.Photo.DFFAVG(i(1),:)';
xlim([-4 4]);
%RewPE
subplot(1,3,2)
hold on
