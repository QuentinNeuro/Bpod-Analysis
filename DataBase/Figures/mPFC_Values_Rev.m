...
plot(DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.Time',...
     DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.DFF0Cue,'-k');
xlim([-4 4]); ylim([-5 15]);
title('CueA - Low Value')

subplot(3,7,[5 6]) % High Value
plot(DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.Time',...
     DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.DFF0Cue,'-b');
xlim([-4 4]); ylim([-5 15]);
title('Cue B - High Value')

% Cue         
Cue(1,:)=DB_CuedOutcome.mPFC_Values_Rev.NoCue.Photo.DFFCue-...
            DB_CuedOutcome.mPFC_Values_Rev.NoCue.Photo.DFF0Cue;
Cue(2,:)=DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA.Photo.DFFCue-...
            DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA.Photo.DFF0Cue;
Cue(3,:)=DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB.Photo.DFFCue-...
            DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB.Photo.DFF0Cue;
subplot(3,7,7)
plot(Cue,'-o')
xlim([0 4])
ylim([-2 10])
...
plot(DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.Time',...
     DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.DFF0Outcome,'-k');
xlim([-0.1 2]); ylim([-5 10])

subplot(3,7,[12 13]) % High Value
plot(DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.Time',...
     DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.DFFAVG'-...
     DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.DFF0Outcome,'b');
xlim([-0.1 2]); ylim([-5 10]);
% Reward
...
Rew(2,:)=DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.DFFOutcome-...
            DB_CuedOutcome.mPFC_Values_Rev.NoAnticipLick_CueA_Reward.Photo.DFF0Outcome;
Rew(3,:)=DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.DFFOutcome-...
            DB_CuedOutcome.mPFC_Values_Rev.AnticipLick_CueB_Reward.Photo.DFF0Outcome;
subplot(3,7,14)
plot(Rew,'-o')
xlim([0 4])
ylim([-2 10])
