...
if ischar(Time)
    switch Time
        case 'Cue'
            Time=Analysis.AllData.Time.Cue(i,:)+Analysis.Parameters.Timing.CueTimeReset;
        case 'Outcome'
            Time=Analysis.AllData.Time.Outcome(i,:)+Analysis.Parameters.Timing.OutcomeTimeReset;
    end
end
