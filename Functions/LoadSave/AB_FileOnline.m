...
global BpodSystem
BpodPSTH=[BpodSystem.Data.TrialSettings(1).GUI.TimeMin-2  BpodSystem.Data.TrialSettings(1).GUI.TimeMax+2];
...
LP.P.Plot.xTime=BpodPSTH;
LP.P.Timing.PSTH=BpodPSTH; % use online PSTH ?
% Data Normalization
