...
Group_Plot{indexp,2}={'Cued_Reward',               	{'type_1','LicksCue','LicksOutcome'};...
...
% Correlations
        indexc=indexc+1;
Group_Corr{indexc,1}='ExpectationCorrelation';
Group_Corr{indexc,2}={'Cued_Reward',                {'type_1','LicksCue','LicksOutcome'};...
                    'BiggerReward',                 {'type_3','LicksCue','LicksOutcome'};...
                    'SmallerReward',                {'type_2','LicksCue','LicksOutcome'}};
...
if Analysis.Parameters.Wheel
    indexp=indexp+1;
Group_Plot{indexp,1}='Running';
Group_Plot{indexp,2}={'Cue_B_Reward_Run',         	{'Cue A','Reward','LicksOutcome','Run'};...
                      'Cue_B_Reward_noRun',        	{'Cue A','Reward','LicksOutcome','RunInv'}};
 end
if Analysis.Parameters.Pupillometry
    indexp=indexp+1;
Group_Plot{indexp,1}='CuePupil';
Group_Plot{indexp,2}={'Cue_B_Reward_CuePupil',    	{'Cue A','Reward','LicksOutcome','CuePupil','PupilNaN'};...
